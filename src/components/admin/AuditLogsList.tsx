...
const DateRangePicker: React.FC<{
    ...
    return (
        <div ref={containerRef} style={{ position: 'relative', flex: 1, minWidth: '280px' }}>
            ...
            {isOpen && (
                <div
                    className="dc-audit-date-dropdown"
                    style={{
                        position: 'absolute',
                        top: 'calc(100% + 8px)',
                        zIndex: 100,
...
export const AuditLogsList: React.FC<AuditLogsListProps> = ({ userId, hideUser = false }) => {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
            ...
            <div style={{ gap: '32px', alignItems: 'start', display: 'grid', gridTemplateColumns: selectedLog ? '1fr 400px' : '1fr' }} className="dc-audit-main-grid">
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    ...
                    {/* Pagination Bar */}
                    <div className="dc-audit-pagination" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 10px' }}>
                    ...
                    <style>{`
                        @media (max-width: 767px) {
                            ...
                            .dc-audit-pagination > div {
                                width: 100% !important;
                                justify-content: center !important;
                            }
                            .dc-audit-pagination button {
                                flex: 1 !important;
                            }
