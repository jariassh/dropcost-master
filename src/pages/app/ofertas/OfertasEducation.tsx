    ...
    return (
        ...
        >
            ...
            <div
                ...
                className="dc-education-nav-row"
            >
                {/* Skip */}
                <button
                    onClick={onComplete}
                ...
                {/* Dots */}
                <div style={{ display: 'flex', gap: '8px' }} className="dc-education-nav-dots">
                    {SLIDES.map((_, i) => (
                        <button
                            key={i}
                ...
                {/* Actions */}
                <div style={{ display: 'flex', gap: '8px' }} className="dc-education-nav-actions">
                    {current > 0 && (
                        <button
            ...
            <style>{`
                @media (max-width: 767px) {
                    .dc-education-adv-grid {
                        grid-template-columns: 1fr !important;
                        gap: 12px !important;
                    }
                    .dc-education-nav-row {
                        flex-wrap: wrap;
                        gap: 12px;
                    }
                    .dc-education-nav-dots {
                        width: 100%;
                        order: -1;
                        justify-content: center;
                        margin-bottom: 8px;
                    }
                    .dc-education-nav-actions {
                        flex: 1;
