...
const regex = /<label style=\{\{ fontSize: '11px', fontWeight: 800, color: 'var\(--text-secondary\)', textTransform: 'uppercase', marginBottom: '8px' \}\}>\s*Nivel de Ambición\s*<\/label>/;
// Wait, that one is for ambition level.
