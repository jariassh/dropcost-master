...
### RF-073: Textos y Mensajes - Usuario Sin Referidos

**Pantalla:** Sistema de Referidos → Primera vez (sin referidos aún)

**Titular:**
```
✅ "Comparte DropCost con tu comunidad de Dropshippers"
```

**Descripción:**
```
"Conoces Dropshippers que buscan optimizar costos? Refieralos a DropCost.
Como agradecimiento, ganas 15% de su suscripción cada mes (hasta 12 meses).

Ellos ahorran dinero. Tú ganas comisión. Win-Win.

Este no es un programa de MLM. Es simple: recomendas una herramienta que usas,
ganas comisión. Nada más. Solo durante 12 meses."
```
...
### RF-074: Textos y Mensajes - Usuario En Crecimiento (1-10 Referidos)

**Pantalla:** Sistema de Referidos → Con algunos referidos
...
**Descripción:**
```
"Felicidades, ya tienes {X} referidos usando DropCost.
Estás generando comisiones de manera pasiva mientras ellos ahorran costos.

Sigue compartiendo con tu comunidad. Cada nuevo Dropshipper que se sume
es uno más que está optimizando su margen."
```

**Barra de progreso:**
```
═════▓▓▓▓░░░░░░░░░░░░░░░░░░░░░ {X}/50 Referidos
"Falta {50-X} referidos para acceder a beneficios de Líder"
```

**Beneficios futuros:**
```
Cuando llegues a 50 referidos, desbloquearás:
✓ 5% adicional en comisiones (Nivel 2)
✓ Acceso a métricas avanzadas de tu red
✓ Badge de Líder en tu perfil
```

---

### RF-075: Textos y Mensajes - Usuario Próximo a Líder (40-50 Referidos)

**Pantalla:** Sistema de Referidos → A punto de alcanzar Líder

**Titular:**
```
"¡Casi eres Líder de tu comunidad! 🚀"
```

**Descripción:**
```
"Faltan solo {X} referidos para alcanzar el rango de Líder.

En DropCost, un Líder no es alguien que gana dinero por dinero.
Es alguien que de verdad ha logrado que su comunidad de Dropshippers 
optimice sus márgenes. Es un validador de valor."
```

**Motivación:**
```
"Tus primeros {X} referidos ya están usando DropCost.
Imagina cuánto dinero ahorran mensualmente en costos.

Solo necesitas {50-X} más para convertirte en Líder y empezar a ganar
en su Nivel 2 (5% adicional)."
```

---

### RF-076: Textos y Mensajes - Usuario Acaba de Ser Líder

**Pantalla:** Sistema de Referidos → Acaba de alcanzar 50+ referidos

**Titular:**
```
"🎉 ¡Felicidades! Eres Líder de tu Comunidad"
```

**Descripción:**
```
"Alcanzaste {X} referidos activos. Eso no es casualidad.

Significa que {X} Dropshippers en tu red confían en tu recomendación de DropCost.
Que {X} personas ahorran dinero cada mes gracias a que conocieron la herramienta
contigo.

A partir de ahora, ganas un 5% adicional en las comisiones de los referidos
que ELLOS traigan (Nivel 2). Durante 12 meses."
```
...
Juan (tu referido) refiere a Carlos.
Tú ganas 5% de la suscripción de Carlos.
Juan sigue ganando su 15% normal.

Nadie pierde. Solo se suma valor."
```

**Beneficios de ser Líder:**
```
✓ 5% extra en la red de tus referidos
✓ Acceso a métricas avanzadas
✓ Badge 'Líder' en tu perfil
✓ Prioridad en soporte
```

**P.S.:**
```
"Recuerda: tus comisiones tienen validez por 12 meses desde que cada
referido se registra. Después, simplemente se convierten en clientes de DropCost.
Sin obligaciones, sin 'mantener la red activa'. Solo recomendaciones con valor."
```

---

### RF-077: Textos y Mensajes - Usuario Líder Establecido (100+ Referidos)

**Pantalla:** Sistema de Referidos → Líder consolidado

**Titular:**
```
"Liderizando la optimización de márgenes en tu comunidad 👑"
```

**Descripción:**
```
"Llevas {X} meses siendo Líder. {Z} Dropshippers en tu comunidad
están usando DropCost como su herramienta de costeo gracias a ti.

Eso es impacto real. Cada uno de esos {X} usuarios sabe cuál es su margen exacto,
su CPA real, y está tomando decisiones basadas en datos. Porque los referiste.

Tu comisión este mes: ${amount} (Nivel 1 + Nivel 2)
Comisión histórica: ${total_lifetime}"
```

**Datos de impacto:**
```
"Lo que tu red está ahorrando (estimado):"
├─ Horas en costeos manuales: {X} horas/mes
├─ Decisiones malas evitadas: ~{Y} productos/mes
└─ Margen total optimizado en tu red: ${Z}/mes
```

**Mensaje sobre validez de comisiones:**
```
"Tus comisiones son vigentes hasta 12 meses desde que cada referido se registra.
Una vez expiran, se convierten en clientes puros de DropCost.

Esto es intencional. No queremos gente ganando dinero infinitamente sin hacer nada.
Queremos que recomiendes porque de verdad crees en el valor de la herramienta,
no porque 'necesites mantener la red activa'."
```

---

### RF-078: Textos y Mensajes - Cartel Educativo Bienvenida

**Ubicación:** Sistema de Referidos → Primer acceso

**Cartel de bienvenida (informativo, puede cerrarse):**
```
╔════════════════════════════════════════════════════════════╗
║                                                            ║
║  BIENVENIDO AL SISTEMA DE REFERIDOS DE DROPCOST MASTER   ║
║                                                            ║
║  Esto NO es un programa de MLM.                           ║
║  Es simple comisión por recomendación.                    ║
║                                                            ║
║  ¿Cómo funciona?                                          ║
║                                                            ║
║  1. Compartes tu enlace con Dropshippers que conoces      ║
║  2. Si se registran con tu código, ganas 15%              ║
║  3. Si ellos refieren a otros, ganas 5% adicional         ║
║  4. Máximo 12 meses de comisión por referido              ║
║                                                            ║
║  ¿Cuándo se convierte en MLM?                             ║
║  • Cuando ganas dinero solo por reclutar (aquí no)        ║
║  • Cuando la gente debe comprar para 'activar' (aquí no)  ║
║  • Cuando ganas infinitamente sin hacer nada (aquí no)    ║
║                                                            ║
║  ¿Por qué solo 12 meses?                                  ║
║  Porque después, son clientes nuestros. No queremos que   ║
║  pienses que tu único valor es tenerlos 'reclutados'.     ║
║  Tu valor está en la RECOMENDACIÓN INICIAL.               ║
║                                                            ║
║  Recomenda porque crees en DropCost.                      ║
║  Si no, no lo hagas. La herramienta habla sola.           ║
║                                                            ║
║                             [Entendido] [Más info]        ║
║                                                            ║
╚════════════════════════════════════════════════════════════╝
...
### RF-079: Textos y Mensajes - Banner Educativo Permanente

**Ubicación:** Sistema de Referidos → Visible siempre en la pantalla

**Banner educativo (colapible):**
```
┌─────────────────────────────────────────────────────────┐
│                                                         │
│ 💡 ¿Por qué limitamos comisiones a 12 meses?          │
│                                                         │
│ Porque no queremos que pienses que los Dropshippers   │
│ que recomiendas te 'pertenecen' para siempre.          │
│                                                         │
│ Tu trabajo es recomendar.                              │
│ Después, son clientes de DropCost que decidieron      │
│ quedarse porque la herramienta les entrega valor.      │
│                                                         │
│ Si necesitaras 'mantenerlos activos' para ganar       │
│ dinero, eso sería MLM.                                │
│ No lo es. Por eso los limitamos a 12 meses.            │
│                                                         │
│                              [Entendido] [Leer más]    │
│                                                         │
└─────────────────────────────────────────────────────────┘
...
### RF-080: Plantillas Email - Ascenso a Líder

**Asunto:** 🎉 Acabas de alcanzar el rango de Líder

**Contenido:**
```
Hola {nombre},

Alcanzaste 50 referidos activos en DropCost Master.

No te lo enviaremos todos los días. Solo una vez. Porque este es un logro real.

Significa que 50 Dropshippers en tu comunidad confían en tu recomendación.
Que están ahorrando dinero porque los introdujiste a una herramienta que 
realmente funciona.

A partir de ahora, ganas 5% adicional en los referidos que TUS referidos traigan.

Eso es todo. Sin certificados falsos. Sin 'bonos especiales'. Sin drama.
Solo la comisión que mereces por ser alguien cuya recomendación tiene peso.

[Ver Mi Panel de Líder]

---
DropCost Master
```

**Contexto:** Se envía cuando usuario es ascendido automáticamente a Líder

---

### RF-081: Plantillas Email - Comisión Próxima a Expirar

**Asunto:** ⏰ Recordatorio: Tu comisión de {usuario} vencerá en 30 días

**Contenido:**
```
Hola {nombre},

Tu referido {usuario} fue suscrito hace 11 meses.

En 30 días, su suscripción ya no generará comisión para ti.
Esto es intencional. Diseñamos así porque creemos que tu valor es RECOMENDAR,
no 'mantener a la gente activa'.

Después de que su comisión expire, seguirá siendo cliente de DropCost.
Eso está bien. Significa que encontró valor en la herramienta y la mantiene.
Eso es una buena recomendación.

[Ver mis referidos activos]

---
DropCost Master
```

**Contexto:** Se envía 30 días antes de que expire comisión de un referido

---

### RF-082: Plantillas Email - Comisión Expirada

**Asunto:** ✅ La comisión de {usuario} ya ha expirado (cambió a cliente)

**Contenido:**
```
Hola {nombre},

Tu referido {usuario} completó sus 12 meses de comisión.

A partir de hoy, se convierte en cliente regular de DropCost.
Eso significa que la herramienta le entregó valor suficiente para quedarse.
Eso es exactamente lo que queremos.

Seguirá usando DropCost, ahorrando en costos, optimizando márgenes.
Solo que ahora sin generar comisión recurrente para ti.

Esto no es un castigo. Es la naturaleza del sistema:
Tu valor está en la recomendación. Después, la herramienta habla sola.

¿Quieres seguir creciendo tu red? 
Sigue recomendando a otros Dropshippers.
Cada uno genera 12 meses de comisión.
...
**Contexto:** Se envía cuando comisión expira completamente (después de 12 meses)
...
**RF-064 a RF-082 (19 requerimientos funcionales)**
